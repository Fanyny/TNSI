...
####DEBUT de Config git#####
#remplacer "Fanyny" par votre "user" github
git config --global user.name "Fanyny"

#modifier l'email avec votre "email" github
git config --global user.email "xiefanny367@gmail.com"

git config --global --list

#cle ssh
#modifier l'email avec votre "email" github
ssh-keygen -t ed25519 -C "xiefanny367@gmail.com"
####FIN de Config git#####
